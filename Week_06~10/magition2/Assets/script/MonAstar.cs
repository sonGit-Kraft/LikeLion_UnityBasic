...
public class MonAstar : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            // 마우스 클릭시 bottomLeft, topRight, startPos, targetPos 정해준 다음 길찾기
        ...
        if (FinalNodeList.Count != 0)
        {
            ...
            PlayerTR.position = Vector2.MoveTowards(PlayerTR.position, FinalNodePos, 0.03f);
